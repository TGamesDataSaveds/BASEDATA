...
class DiscordClient
{
	...
	private static var _defaultID:String = "1202371760977088554";
	...
	private static var _options:Dynamic = {
		...
		largeImageText: "Ending Corruption",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageKey = 'iconog';
		_options.largeImageText = "Ending Corruption: V" + ClientPrefs.data.endingCorruprion;
