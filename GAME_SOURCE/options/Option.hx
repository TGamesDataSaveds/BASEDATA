...
class Option
{
	...
	public function new(name:String, description:String = '', variable:String, type:String = 'bool', ?options:Array<String> = null, id:Int = 0)
	{
		this.name = name;
	...
	private function get_type()
	{
		...
		{
			case 'int' | 'float' | 'percent' | 'string' | 'Int' | 'String': newValue = type;
