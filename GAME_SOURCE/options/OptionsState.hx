...
class OptionsState extends MusicBeatState
{
	...
	public static var optionsSpanish:Array<String> = [
		'AJUSTAR',
		'GRAFICOS',
		'EFECTOS VISUALES',
	...
	public static var optionsOther:Array<String> = [
		'AJUSTAR',
		'GRAFICOS',
		'EFEITOS VISUAIS',
	...
	override function create() {
		...
		reloadButton.loadGraphic(Paths.image('icons/Menu/reloadIcon'));
	...
	override function update(elapsed:Float) {
		...
		if (FlxG.mouse.overlaps(reloadButton)) {
			FlxTween.cancelTweensOf(reloadButton, ["alpha"]);
			FlxTween.tween(reloadButton, {alpha: 1}, 0.3);
			FlxTween.angle(reloadButton, 0, 360, 2, {ease: FlxEase.circInOut, type: LOOPING});
		} else {
			if (reloadButton.alpha != 0.3) FlxTween.cancelTweensOf(reloadButton, ["alpha"]);
			FlxTween.tween(reloadButton, {alpha: 0.3}, 0.6);
			FlxTween.angle(reloadButton, 0, 360, 2, {ease: FlxEase.circInOut, type: LOOPING});
		}
