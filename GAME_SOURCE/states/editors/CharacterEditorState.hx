...
class CharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		textAnim.setFormat(Paths.font("new/BUND.otf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		for (i in 0...tipTextArray.length-1)
		{
			...
			tipText.setFormat(Paths.font("new/BUND.otf"), 12, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
	...
	function reloadCharacterDropDown() {
		...
		characterList = [];
		var directories:Array<String> = ['assets/characters/', 'assets/characters/', Paths.getPreloadPath('characters/')];
		directories.push('assets/characters/');
		for (i in 0...directories.length) {
			var directory:String = directories[i];
			if(FileSystem.exists(directory)) {
				for (file in FileSystem.readDirectory(directory)) {
