	...
	override function eventCalled(eventName:String, value1:String, value2:String, flValue1:Null<Float>, flValue2:Null<Float>, strumTime:Float)
	{
		switch(eventName)
		{
			case "Background Black":
				if (flValue1 == 1 || value1 == 'true' || value1 == 'TRUE' || value1 == 'True') {
				FlxTween.tween(bg, {alpha: 0}, flValue2);
				FlxTween.tween(city, {alpha: 0}, flValue2);
				FlxTween.tween(streetBehind, {alpha: 0}, flValue2);
				FlxTween.tween(phillyStreet, {alpha: 0}, flValue2);

				FlxTween.tween(sky, {alpha: 0}, flValue2);
				FlxTween.tween(cityBack, {alpha: 0}, flValue2);
				FlxTween.tween(streetBehindDark, {alpha: 0}, flValue2);
				FlxTween.tween(phillyStreetDark, {alpha: 0}, flValue2);
				} else if (flValue1 == 0 || value1 == 'false' || value1 == 'FALSE' || value1 == 'False') {
				FlxTween.tween(bg, {alpha: 1}, flValue2);
				FlxTween.tween(city, {alpha: 1}, flValue2);
				FlxTween.tween(streetBehind, {alpha: 1}, flValue2);
				FlxTween.tween(phillyStreet, {alpha: 1}, flValue2);
	
				FlxTween.tween(sky, {alpha: 1}, flValue2);
				FlxTween.tween(cityBack, {alpha: 1}, flValue2);
				FlxTween.tween(streetBehindDark, {alpha: 1}, flValue2);
				FlxTween.tween(phillyStreetDark, {alpha: 1}, flValue2);
				}
			case "change stage":
			...
			case "Change Character":
				if (value2 == 'pico_dark' || value2 == 'bf_dark') {
				...
				if (value2 == 'pico' || value2 == 'bf-origin') {
					camGame.flash(FlxColor.WHITE, 0.2);
